...
const stats = [
  { number: "+35", label: "Años de Experiencia", icon: Clock },
  { number: "+20,000", label: "Clientes Satisfechos", icon: Users },
  { number: "10", label: "Sucursales", icon: Globe },
  { number: "+15,000", label: "Productos", icon: Award },
]
...
const timeline = [
  {
    year: "1954",
    title: "Fundación",
    description: "Se funda Oxígeno y Acetileno SA (OASA) en la ciudad de Mexicali, Baja California.",
  },
  {
    year: "1991",
    title: "Expansión",
    description: "OASA se expande a Ciudad Juárez, Chihuahua a través de Oxigeno y Soldaduras de Juárez SA de CV.",
  },
  {
    year: "2011",
    title: "Ampliación geográfica",
    description: "Comienza el crecimiento geográfico al irse poco a poco abriendo las sucursales de Torreón, Dirango, Chihuahua, Aguascalientes y Monterrey.",
  },
  {
    year: "2022",
    title: "Consolidación como empesa",
    description: "Nos posicionamos como expertos en soldadura y reiteramos nuestro compromiso con la industria mexicana.",
  },
]
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Ser un proveedor industrial de excelencia, agregando valor a la cadena de suministro de nuestros clentes 
                  por medio de un excelente servicio, entregando los insumos requeridos en tiempo y forma, aportando recomendaciones 
                  técnicas y dando a nuestros clients las soluciones más novedosas en soldadura, metalmecánica y MRO.

                </p>
                <h3 className="text-2xl font-bold mb-4 text-gray-900">Nuestra Visión</h3>
                <p className="text-lg text-gray-600 leading-relaxed">
                  Incrementar la competitividad de la industria Mexicana por medio de la proveeduría de excelencia, contribuyendo 
                  a la eficiencia en la operación y a la reducción de costos. Contribuir al desarrollo nacional por medio 
