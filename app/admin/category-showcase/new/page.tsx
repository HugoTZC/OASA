...
export default function NewCategoryShowcase() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert("Failed to create category showcase")
      }
    } catch (error) {
      console.error("Failed to create category showcase:", error)
      alert("Failed to create category showcase")
    } finally {
      setLoading(false)
    }
  ...
  return (
    <div>
      <div className="flex items-center mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Add Category Showcase</h1>
          <p className="text-gray-600 mt-2">Create a new featured category section</p>
        </div>
      </div>
